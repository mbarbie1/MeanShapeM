function [hd ahd D] = HausdorffDist(P,Q,lmf,dv)
% Calculates the Hausdorff Distance between P and Q
%
% [hd ahd] = HausdorffDist(P,Q)
% [hd ahd D] = HausdorffDist(P,Q)
% [hd ahd D] = HausdorffDist(...,lmf)
% [hd ahd D] = HausdorffDist(...,[],'visualize')
%
